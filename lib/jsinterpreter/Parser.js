require('../ometa/Ometa')
require('./generated/Translator')
require('./generated/Nodes')
require('./LivelyJSParser')

// LivelyJSParser is the OMeta parser defined in jsinterpreter.LivelyJSParser.ometa
...
Object.extend(jsinterpreter.Parser, {
...
'matching', {
    ...
    matchVal: function(key, value, pattern) {
        if (pattern === jsinterpreter.Node.placeholder) return value;
...
Object.subclass('jsinterpreter.SourceGenerator',
'documentation', {
    usage: 'gen = new jsinterpreter.SourceGenerator();\n\
gen.writeAndEvalTranslator();\n\
gen.evalAndWriteClasses();\n\
jsinterpreter.Parser.astTranslator = JSTranslator;\n\
jsinterpreter.Parser.jsParser = LivelyJSParser;',

    showUsage: function() {
        $world.addTextWindow({content: this.usage, title: "jsinterpreter.SourceGenerator usage"})
    }
},
'settings', {
    ...
    modulePath: 'jsinterpreter.',
    rootNodeClassName: 'jsinterpreter.Node',
    visitorClassName: 'jsinterpreter.Visitor'
},
'translator rules', {
...
'rule creation', {
    ...
    writeAndEvalTranslator: function() {
        ...
        var content = Strings.format(
            'module(\'jsinterpreter.generated.Translator\').' +
...
'class creation', {
    ...
    parentCallsFromRules: function(ruleSpec) {
        // new jsinterpreter.SourceGenerator().parentCallsFromRules({rules: ['trans:foo', 'trans*:bar']})
        var parentCalls = [];
...
'visitor creation', {
    ...
    doubleDispatchCategoryForVisitor: function() {
        // new jsinterpreter.SourceGenerator().doubleDispatchCategoryForVisitor()
        // currently not used
...
Object.extend(jsinterpreter.Node, {
    placeholder: {}
});
