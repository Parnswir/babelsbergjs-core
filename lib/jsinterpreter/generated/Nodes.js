Object.subclass('jsinterpreter.Node');

jsinterpreter.Node.subclass('jsinterpreter.Sequence',
'testing', {
	isSequence: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.Number',
'testing', {
	isNumber: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.String',
'testing', {
	isString: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.Cond',
'testing', {
	isCond: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.If',
'testing', {
	isIf: true,
},
'initializing', {
	initialize: function ($super, pos, condExpr, trueExpr, falseExpr) {
                ...
                this.trueExpr = trueExpr.isSequence || this.isUndefined(trueExpr) ?
                    trueExpr : new jsinterpreter.Sequence(trueExpr.pos, [trueExpr]);
                this.falseExpr = falseExpr.isSequence || this.isUndefined(falseExpr) ?
                    falseExpr : new jsinterpreter.Sequence(trueExpr.pos, [falseExpr]);
                condExpr.setParent(this);
...
jsinterpreter.Node.subclass('jsinterpreter.While',
'testing', {
	isWhile: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.DoWhile',
'testing', {
	isDoWhile: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.For',
'testing', {
	isFor: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.ForIn',
'testing', {
	isForIn: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.Set',
'testing', {
	isSet: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.ModifyingSet',
'testing', {
	isModifyingSet: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.BinaryOp',
'testing', {
	isBinaryOp: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.UnaryOp',
'testing', {
	isUnaryOp: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.PreOp',
'testing', {
	isPreOp: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.PostOp',
'testing', {
	isPostOp: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.This',
'testing', {
	isThis: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.Variable',
'testing', {
	isVariable: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.GetSlot',
'testing', {
	isGetSlot: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.Break',
'testing', {
	isBreak: true,
},
'initializing', {
	initialize: function ($super, pos, label) {
            		this.pos = pos;
            		this.label = label || new jsinterpreter.Label([pos[1], pos[1]], '');
...
jsinterpreter.Node.subclass('jsinterpreter.Debugger',
'testing', {
	isDebugger: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.Continue',
'testing', {
	isContinue: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.ArrayLiteral',
'testing', {
	isArrayLiteral: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.Return',
'testing', {
	isReturn: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.With',
'testing', {
	isWith: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.Send',
'testing', {
	isSend: true,
},
'initializing', {
...
'debugging', {
	...
	toString: function () {
                return Strings.format('%s(%s[%s](%s))',
                    this.constructor.name, this.recv, this.property, this.args?this.args.join(','):'')
            },
},
'conversion', {
	asJS: function (depth) {
...
jsinterpreter.Node.subclass('jsinterpreter.Call',
'testing', {
	isCall: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.New',
'testing', {
	isNew: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.VarDeclaration',
'testing', {
...
jsinterpreter.Node.subclass('jsinterpreter.Throw',
'testing', {
	isThrow: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.TryCatchFinally',
'testing', {
...
jsinterpreter.Node.subclass('jsinterpreter.Function',
'testing', {
	isFunction: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.ObjectLiteral',
'testing', {
...
jsinterpreter.Node.subclass('jsinterpreter.ObjProperty',
'testing', {
	isObjProperty: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.ObjPropertyGet',
'testing', {
...
jsinterpreter.Node.subclass('jsinterpreter.ObjPropertySet',
'testing', {
...
jsinterpreter.Node.subclass('jsinterpreter.Switch',
'testing', {
	isSwitch: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.Case',
'testing', {
	isCase: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.Default',
'testing', {
	isDefault: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.Regex',
'testing', {
	isRegex: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.Label',
'testing', {
	isLabel: true,
},
'initializing', {
...
jsinterpreter.Node.subclass('jsinterpreter.LabelDeclaration',
'testing', {
...
Object.subclass('jsinterpreter.Visitor',
'visiting', {
