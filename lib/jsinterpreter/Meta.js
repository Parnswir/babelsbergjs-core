...
'meta programming interface', {
    ...
    updateSource: function(source) {
        var ast = jsinterpreter.Parser.parse(source, "functionDef"),
            newFun = ast.val.eval();
        ...
        jsinterpreter.Meta.ChangeSet.getCurrent().addChange(newFun);
    },
    getClass: function() {
...
Object.subclass('jsinterpreter.Meta.ChangeSet',
'initializing', {
    initialize: function() {
        this.changes = [];
    }
...
Object.extend(jsinterpreter.Meta.ChangeSet, {
    current: null,
    getCurrent: function() {
        if (!this.current) {
