...
require('./core_ext.js')
require('./Layers.js')
require('./jsinterpreter/interpreter.js')


// require('babelsberg.cassowary_ext')
// require('babelsberg.deltablue_ext')
// require('babelsberg.csp_ext')
// require('babelsberg.src_transform')
// require('babelsberg.babelsberg-lively')
// require('sutherland.relax_bbb')
...
Global.babelsberg=Global.bbb;

jsinterpreter.Send.addMethods({
    get args() {
        return this._$args || [];
    },
...
jsinterpreter.InterpreterVisitor.
    ...
    shouldInterpret: function(frame, func) {
        if (func.sourceModule ===
                Global.babelsberg.constraintinterpreter) {
            return false;
        }
